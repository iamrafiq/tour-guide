    ...
    priceDiscournt: {
      ...
      validate: {
        validator: function (val) {
          //this only points current doc or New document creation, will not work for update
          return val < this.price; // if true then valid input, if false then invalid input
        },
